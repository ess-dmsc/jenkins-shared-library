...
class DefaultContainerBuildNodeImages {
  static images = [
    'centos7-gcc11': [
      'image': 'dockerregistry.esss.dk/ecdc_group/build-node-images/centos7-build-node:11.0.0',
    ...
    'debian11': [
      'image': 'dockerregistry.esss.dk/ecdc_group/build-node-images/debian11-build-node:3.0.0',
      'shell': 'bash -e -x'
    ],
    'ubuntu2004': [
    ...
    'ubuntu2204': [
      'image': 'dockerregistry.esss.dk/ecdc_group/build-node-images/ubuntu22.04-build-node:3.0.0',
      'shell': 'bash -e -x'
    ]
  ]
}
