...
class DefaultContainerBuildNodeImages {
  static images = [
    ...
    'almalinux8-gcc12': [
      'image': 'registry.esss.lu.se/ecdc/ess-dmsc/docker-almalinux8-build-node:1.0.0',
      'shell': '/usr/bin/scl enable gcc-toolset-12 -- /bin/bash -e -x'
    ],
    'debian11': [
      'image': 'registry.esss.lu.se/ecdc/ess-dmsc/docker-debian11-build-node:5.0.0',
      'shell': 'bash -e -x'
    ],
    'ubuntu2204': [
      'image': 'registry.esss.lu.se/ecdc/ess-dmsc/docker-ubuntu2204-build-node:4.0.0',
      'shell': 'bash -e -x'
    ]
  ]
}
